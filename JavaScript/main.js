...
// Desplegar/plegar el submenú de Servicios al pulsar en "Servicios"
...
// Cerrar el submenú si se hace clic fuera del menú desplegable
document.addEventListener('click', (e) => {
  if (itemDesplegable && !itemDesplegable.contains(e.target)) {
...
document.querySelectorAll('.enlace-menu, .enlace-submenu').forEach(enlace => {
  enlace.addEventListener('click', (e) => {
    // Si es el disparador de "Servicios", la lógica la maneja su propio evento
    if (enlace === enlaceDesplegable) {
      return;
    }
